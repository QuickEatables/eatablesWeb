...
export const Home = () => {
  ...
  return (
    <div className={styles.main}>
      ...
      <h1 className={styles.trans_h1}>Vendor Agreement</h1>
      ...
      <div className={styles.cookie_wrapper}>
          ...
          <div className={styles.cookieNav_wrapper}>
            <Link
              className={`${styles.link} ${
                pathname === "/vendor-agreement" ? styles.active : ""
              }`}
        ...
        <section className={styles.cookie_main}>
          ...
          <p>This Vendor Agreement (hereinafter referred to as "this Agreement") is made and entered into this ____ day of _______ 2024 (hereinafter referred to as "Effective Date")</p>

          <h4>Between</h4>
          <p>Quickeatables Delivery Limited, a private limited liability company duly incorporated and registered under the laws of the Federal Republic Nigeria with registration number (RC) 7321515 and having as its registered office at _______________, (hereinafter referred to as "Eatables");</p>

          <p>and</p>

          <p>___________, a company/business name duly incorporated under the laws of the Federal Republic of Nigeria and with its registered office at ______________ Nigeria (hereinafter referred to as "Vendor") which expression shall where the context so admits include its subsidiaries, successor-in title and assigns) on the other part.</p>
